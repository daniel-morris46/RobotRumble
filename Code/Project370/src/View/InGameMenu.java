...
public class InGameMenu extends JFrame {
    ...
    /**
     * Public constructor. Constructs the frame and board using the given hexes per edge.
     * 
    ...
    public InGameMenu(Board b) {
        ...
        actionToggleButton = new JButton("*"); // Creating action toggle button and adding it to
                                               // panel
    ...
    private class ForfeitButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i = 0; i < 3; i++) {
                Controller.getInstance().gameBoard.getTeams()[Controller.getInstance().gameBoard
                        .getCurrentTeam()].getTeamOfRobot()[i].setHealth(0);
            }
