...
public class OptionsMenuPanel extends JPanel{
	...
	private class RobotInfoPanel extends JPanel{
		...
		/**
		 * Creates a robot info panel for displaying the given robot, as well as 
		 * importing the robot's script to a local directory.
		 * 
		...
		/**
		 * The action listener for the import button, which imports the robot's script
		 * to the src/Model/scripts/ directory when pressed.
		 */
