...
public class Controller {
    ...
    public void G_turnLeft() {
        ...
        if (gameBoard.isGameMode()) {
            int currentRotation = gameBoard.Teams[gameBoard.getCurrentTeam()]
                    .getTeamOfRobot()[gameBoard.getCurrentRobot()].getAbsDirection();
            if (currentRotation == 0) {
                gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                        .getCurrentRobot()].setAbsDirection(5);
            } else {
                gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                        .getCurrentRobot()].setAbsDirection(currentRotation - 1);
            }
            System.out.print(gameBoard.Teams[gameBoard.getCurrentTeam()].getColour() + " ");
            if (gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                    .getCurrentRobot()].getType() == 1) {
                System.out.print("Scout");
            } else if (gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                    .getCurrentRobot()].getType() == 2) {
    ...
    public void G_turnRight() {
        ...
        if (gameBoard.isGameMode()) {
            ...
            if (currentRotation == 5) {
                gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                        .getCurrentRobot()].setAbsDirection(0);
            } else {
                gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                        .getCurrentRobot()].setAbsDirection(currentRotation + 1);
            }
    ...
    public void G_endPlay() {
        ...
        gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard.getCurrentRobot()]
                .setMovementCur(0);
        gameBoard.Teams[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard.getCurrentRobot()]
                .setHasShot(false);
        ...
        while (!gameBoard.getTeams()[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                .getCurrentRobot()].isAlive()) {
            // change robot to next robot
            if (gameBoard.getCurrentRobot() >= 2) {
                gameBoard.setCurrentRobot(0);
            } else {
        ...
        gameBoard.updateMovementColours(curRobot, curX, curY, gameBoard,
                curRobot.getAbsDirection());

        if (!(gameBoard.getTeams()[gameBoard.getCurrentTeam()].isHuman())) {

            gameBoard.getTeams()[gameBoard.getCurrentTeam()].getTeamOfRobot()[gameBoard
                    .getCurrentRobot()].getRobotInterpreter().runWord("play");
            G_endPlay();
        }
    }
    ...
    public void G_Move() {
        ...
        if (curRobot.getAbsDirection() == 0) {
            ...
            if (curX < gameBoard.getSize() - 1 && curX + curY < gameBoard.getSize() - 1) {
                ...
                System.out.println(" moved from (" + curX + "," + curY + ") to (" + (curX + 1) + ","
                        + curY + ")");
                curRobot.setMovementCur(curRobot.getMovementCur() + 1);
                gameBoard.updateHexColours();
                gameBoard.updateMovementColours(curRobot, curRobot.getPosition().getPositionX(),
                        curRobot.getPosition().getPositionY(), gameBoard,
                        curRobot.getAbsDirection());
                return;
            }
            ...
            if (curX + curY > -(gameBoard.getSize() - 1) && curY > -(gameBoard.getSize() - 1)) {
                ...
                System.out.println(" moved from (" + curX + "," + curY + ") to (" + curX + ","
                        + (curY - 1) + ")");
                curRobot.setMovementCur(curRobot.getMovementCur() + 1);
                gameBoard.updateHexColours();
                gameBoard.updateMovementColours(curRobot, curRobot.getPosition().getPositionX(),
